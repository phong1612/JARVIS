...
JARVIS runs its LLM (via Ollama), speech-to-text, text-to-speech, and vector storage entirely on-device. No conversation, file content, or personal data is sent anywhere by default.
