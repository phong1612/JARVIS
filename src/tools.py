...
workspaces = {
    "coding": ["vscode", "brave"],
    "trading": ["tradingview", "brave"],
    "study": ["notion", "obsidian"],
}
webspaces = {
    "entertainment": ["youtube", "facebook"],
...
def get_date():
    ...
    return f"The current date is {strftime('%Y-%m-%d', localtime())}."
...
if __name__ == '__main__':
    open_app('tradingview')
    # open_url('chatgpt.com', 'brave')